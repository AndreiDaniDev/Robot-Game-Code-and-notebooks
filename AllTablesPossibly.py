...
async def gyroForward(distance: float, speed: int, target: float = 0, * , kp: float = 0.25, kd: float = 0.3, stop: bool = True, reset: bool = True):
...
async def gyroBackwards(distance: float, speed: int, target: float = 0, * , kp: float = 0.25, kd: float = 0.3 , stop: bool = True, reset: bool = True):
...
async def run1_WPI():
    ...
    await gyroForward(65, 600, -20.5, kp = 0.75, kd = 0)
    await runloop.sleep_ms(500)
    motor.run_for_degrees(leftSystemMotor, -300, 150)
    await gyroForward(4.75, 200, kp = 0.4, kd = 0.3)
    await runloop.sleep_ms(500)
    motor.run_for_degrees(rightSystemMotor, -210, 1000)
    await gyroBackwards(70, 1000, 375, kp = 0.75, kd = 0.2)
...
async def run3_WPI():
    ...
    # ---> Getting in position <---
    await gyroBackwards(0.1, 200, kp = 0.4, kd = 0.25)
    await gyroForward(53, 750, kp = 0.4, kd = 0.25, reset = False)
    await runloop.sleep_ms(250)
    await turnRightOneWheel(42.25, 650, 150, kp = 0.62, kd = 0, reset = False)
    await runloop.sleep_ms(250)
    ...
    await gyroForward(52.325, 750, kp = 0.4, kd = 0.25)
    await runloop.sleep_ms(250)
    await turnRightOtherWheel(87, 500, 150, kp = 0.62, kd = 0, reset = False)
    await runloop.sleep_ms(250)
    await gyroForward(10, 250, kp = 0.4, kd = 0.3)
    await runloop.sleep_ms(250)
    ...
    await runloop.sleep_ms(250)
    await turnLeft(85, 500, 150, reset = False, kp = 0.6, kd = 0)
    await runloop.sleep_ms(250)
    await gyroForward(10, 300, kp = 0.4, kd = 0.25)
    await runloop.sleep_ms(250)
    await motor.run_for_degrees(leftSystemMotor, 75, 1000)
    await runloop.sleep_ms(250)

    # ---> Returning to the blue base <---
    await turnRight(40, 250, 125, reset=False, kp = 0.62, kd = 0)
    await runloop.sleep_ms(250)
    await gyroForward(14, 250, kp = 0.4, kd = 0.25)
    await turnLeft(40, 250, 125, reset=False, kp = 0.62, kd = 0)
    await gyroForward(7.5, 500, kp = 0.4, kd = 0.25, stop = False)
    await gyroForward(115, 800, 275, kp = 0.4, kd = 0.25)
...
async def run5_WPI():
    ...
    # ---> Slowing down <---
    await gyroForward(8.75, 400, 19, kp = 1.5, kd = 0.25, stop = False)
    await gyroForward(14.75, 500, 19, kp = 1.5, kd = 0.25, reset = False, stop = False)
    await gyroForward(6.5, 375, 19, kp = 1.2, kd = 0.25, reset = False, stop = False)
    await gyroForward(3.25, 250, 19, kp = 1.2, kd = 0.25, reset = False)

    # ---> The marge of error <---
    await runloop.sleep_ms(500)
    await turnRight(75, 500, 175, kp = 0.75, kd = 1.2, reset = False)
    ...
    # ---> Dummy proof <---
    await gyroForward(10.5, 500, 18, kp = 1.2, kd = 0.25)
    await gyroForward(10, 750, kp = 1.2, kd = 0.25)
    await runloop.sleep_ms(250)
...
async def run6_WPI():
    ...
    await turnRight(27.5, 500, 100, kp = 0.75, kd = 0.2)
    await gyroForward(120, 1000, -250, kp = 0.75, kd = 0.3)
    #---> You can't modify after this <---
    return
...
async def run8_WPI():
    ...
    await gyroForward(20.15, 500, kp = 0.2, kd = 0.3)
    ...
    await gyroForward(23.25, 750, 50, kp = 0.75, kd = 0.3, stop = False)
    await gyroForward(12.75, 500, 50, kp = 0.75, kd = 0.3, stop = False, reset = False)
    ...
    # ---> Smiley face after completing all runs <---
