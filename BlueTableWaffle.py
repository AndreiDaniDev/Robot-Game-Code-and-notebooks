...
async def run1_WPI():
    ...
    await gyroForward(65, 600, -21, kp = 0.75, kd = 0.2)
    await runloop.sleep_ms(500)
    motor.run_for_degrees(leftSystemMotor, -375, 150)
    await gyroForward(5, 200, kp = 0.4, kd = 0.3)
    await runloop.sleep_ms(500)
...
async def run2_WPI():
    ...
    #---> You can modify after this <---
    await gyroForward(57.5, 1000, 375, kp = 0.4, kd = 0.25)
    await runloop.sleep_ms(1000)
    await gyroBackwards(57, 1000, -200)
    #---> You can't modify after this <---
    return
...
async def run3_WPI():
    ...
    await turnRightOneWheel(42, 650, 150, kp = 0.575, kd = 0, reset = False)
    await runloop.sleep_ms(250)
    await gyroForward(20, 375, kp = 0.5, kd = 0.25)
    await runloop.sleep_ms(250)
    await turnRightOneWheel(42.25, 650, 150, kp = 0.575, kd = 0, reset = False)
    await runloop.sleep_ms(250)

    # ---> Solving M11 (Light Show) <---
    await gyroForward(52.75, 750, kp = 0.4, kd = 0.25)
    await runloop.sleep_ms(250)
    await turnRightOtherWheel(83.725, 500, 150, kp = 0.62, kd = 0, reset = False)
    await runloop.sleep_ms(250)
    await gyroForward(9.75, 250, kp = 0.4, kd = 0.3)
    await runloop.sleep_ms(250)
    ...
    await gyroForward(115, 800, 350, kp = 0.4, kd = 0.25)
...
async def run5_WPI():
    ...
    # ---> Getting in position <---
    await gyroForward(40.75, 600, 19, kp = 1.2, kd = 0.25, reset = False)
    await runloop.sleep_ms(250)
    await turnLeft(44, 650, 125, kp = 0.75, kd = 1)
    await runloop.sleep_ms(250)

    # ---> Slowing down <---
    await gyroForward(8.5, 400, 19, kp = 1.2, kd = 0.25, stop = False)
    await gyroForward(14.25, 500, 19, kp = 1.2, kd = 0.25, reset = False, stop = False)
    await gyroForward(4, 375, 19, kp = 1.2, kd = 0.25, reset = False, stop = False)
    await gyroForward(3.5, 250, 19, kp = 1.2, kd = 0.25, reset = False)
    ...
    await motor.run_for_degrees(leftSystemMotor, 300, 1100)
    await runloop.sleep_ms(250)
    await gyroForward(12.5, 500, 18, kp = 1.2, kd = 0.25)
    await gyroForward(10.25, 750, kp = 1.2, kd = 0.25)
    await runloop.sleep_ms(250)
...
async def run8_WPI():
    ...
    await turnLeft(10, 400, 175, reset = False, kp = 0.02, kd = 0)
    await gyroForward(37.5, 500, kp = 0.2, kd = 0.3)

    await turnLeft(63.5, 500, 175, reset = False)
    await gyroForward(24.375, 750, 50, kp = 0.2, kd = 0.3, stop = False)
    await gyroForward(14, 500, 50, kp = 0.2, kd = 0.3, stop = False, reset = False)
