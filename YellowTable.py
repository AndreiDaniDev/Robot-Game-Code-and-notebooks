...
async def run3_WPI():
    ...
    await runloop.sleep_ms(250)
    await gyroForward(10.5, 250, kp = 0.4, kd = 0.3)
    await runloop.sleep_ms(250)
...
async def run5_WPI():
    ...
    # ---> Getting in position <---
    await gyroForward(36.5, 600, 18, kp = 1.2, kd = 0.25, reset = False)
    await runloop.sleep_ms(250)
    ...
    # ---> Dummy proof <---
    await gyroForward(12.25, 500, 18, kp = 1.2, kd = 0.25)
...
async def run8_WPI():
    ...
    await gyroForward(24.25, 750, 50, kp = 0.2, kd = 0.3, stop = False)
